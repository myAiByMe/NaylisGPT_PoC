...
class NaylisAttention(nn.Module):
    ...
    def __init__(
        ...
        # Créés seulement si use_graph=True.
        # use_graph=False → GPT classique, zéro paramètres supplémentaires.
        if use_graph:
    ...
    def forward(
        ...
        # Seulement si use_graph=True, SDPA ou manuel
        # (varlen ne supporte pas attn_mask custom)
        use_varlen = (
        ...
        # use_graph=False → GPT classique, graph_bias toujours None
